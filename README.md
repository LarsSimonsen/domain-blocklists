...
| List | Scope | Status |
| --- | --- | --- |
| [Headout](data/headout.yaml) | Domains with documented evidence of Headout ownership or operation, including dedicated hostnames on shared services | Verified expanded set: 481 entries |

Additional lists may be added over time, each with its own scope and inclusion criteria.

## Use

The exports contain 481 verified entries and block the listed names and their descendants. Subscribe using the appropriate URL:
